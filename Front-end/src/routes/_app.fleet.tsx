...
function FleetPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      capacity: 1000, odometer: 0, cost: 0, status: "Available",
    },
  });
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search by registration or name…" value={q} onChange={(e) => setQ(e.target.value)} className="pl-9" />
            </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
            ...
            <Field label="Type">
              <Select disabled={retired} defaultValue={form.getValues("type")} onValueChange={(v) => form.setValue("type", v as VehicleType)}>
