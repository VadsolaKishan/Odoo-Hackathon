    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        {[
          ...
          { label: "Total Cost", count: `₹${Math.round(stats.totalCost / 1000)}k`, color: "text-primary" },
                              ...
                              <div className="flex justify-end gap-1.5">
                                {m.status === "Scheduled" && (
                                  <Button
                                    ...
                                    onClick={() => {
                                      updateMaintenance(m.id, { status: "In Progress" });
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    toast.success("Completed · Vehicle set Available");
                                  }}
                                >
