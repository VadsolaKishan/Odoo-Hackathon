...
const rbac: Record<(typeof modules)[number], Record<(typeof roles)[number], Perm>> = {
  Fleet:     { "Fleet Manager": "Manage", Dispatcher: "View",   "Safety Officer": "View",     "Financial Analyst": "Read Only" },
  Drivers:   { "Fleet Manager": "Manage", Dispatcher: "Edit",   "Safety Officer": "Manage",   "Financial Analyst": "Read Only" },
  Trips:     { "Fleet Manager": "View",   Dispatcher: "Manage", "Safety Officer": "View",     "Financial Analyst": "Read Only" },
  Fuel:      { "Fleet Manager": "Edit",   Dispatcher: "Edit",   "Safety Officer": "Read Only","Financial Analyst": "Manage"   },
  Analytics: { "Fleet Manager": "View",   Dispatcher: "View",   "Safety Officer": "View",     "Financial Analyst": "Manage"   },
};
...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Settings" description="General preferences and role-based access controls." />
