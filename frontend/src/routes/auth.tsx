...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — FleetNova" },
      {
        name: "description",
        content: "Sign in to FleetNova to manage your fleet, drivers, trips and operations.",
      },
    ],
  }),
  component: AuthPage,
    ...
    <div className="grid min-h-screen w-full lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-sidebar text-sidebar-foreground lg:flex lg:flex-col lg:justify-between p-10">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            <p className="text-3xl font-extrabold tracking-tight text-sidebar-foreground leading-none">FleetNova</p>
            <p className="text-sm text-sidebar-foreground/70 mt-1">Smart Fleet Operations Platform</p>
          </div>
        </div>
        ...
        <div className="relative text-xs text-sidebar-foreground/50">
          © {new Date().getFullYear()} FleetNova · Frontend Demo
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          <div className="mb-8 lg:hidden flex items-center gap-4">
            ...
            <div>
              <span className="text-2xl font-extrabold tracking-tight text-foreground block leading-none">FleetNova</span>
              <span className="text-sm text-muted-foreground mt-1 block">Smart Fleet Operations Platform</span>
            </div>
          </div>
